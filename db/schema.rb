...
ActiveRecord::Schema.define(:version => 20140815232151) do
  ...
  create_table "response_to_the_evaluations", :force => true do |t|
    ...
    t.integer  "evaluation_criteium_id"
  end

  add_index "response_to_the_evaluations", ["evaluation_criteium_id"], :name => "index_response_to_the_evaluations_on_evaluation_criteium_id"
