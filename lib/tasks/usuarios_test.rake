task :usuarios_test => :environment do
		...
		u1 = User.create(:email => "rafael@cursa.me", :password => "123456", :first_name => "Rafael", :last_name => "Camps", :confirmed_at => Time.now, :personal_url => 'fiahfihfoi53428sa4030',:domain => 'cursa.me', :subdomain => 'test')
		...
		u3 = User.create(:email => "salvador@cursa.me", :password => "mmmmmm", :first_name => "Salvador", :last_name => "Lopez", :confirmed_at => Time.now, :personal_url => 'fiahfih76543foi584sas030',:domain => 'cursa.me', :subdomain => 'test')
