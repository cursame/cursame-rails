 ...
 alumnos3b = [      
    ...
    alumnos3b.each do |alumno|
      ...
      MembersInCourse.create :user_id => user.id, :course_id => 16, :accepted => true, :owner => false, :network_id => network_id, :active_status => true
      MembersInCourse.create :user_id => user.id, :course_id => 18, :accepted => true, :owner => false, :network_id => network_id, :active_status => true
      MembersInCourse.create :user_id => user.id, :course_id => 20, :accepted => true, :owner => false, :network_id => network_id, :active_status => true
      MembersInCourse.create :user_id => user.id, :course_id => 22, :accepted => true, :owner => false, :network_id => network_id, :active_status => true
      MembersInCourse.create :user_id => user.id, :course_id => 24, :accepted => true, :owner => false, :network_id => network_id, :active_status => true
    end  
end